...
cargo test -p encrypt_config --features persist,mock
cargo test -p encrypt_config --features secret,mock
cargo test -p encrypt_config --features persist,default_config_dir
cargo test -p encrypt_config --features persist,default_config_dir,mock
...
cargo run --example impl_persist_example --features persist,mock
cargo run --example impl_secret_example --features secret,mock
cargo run --example impl_persist_example --features persist,mock,default_config_dir
